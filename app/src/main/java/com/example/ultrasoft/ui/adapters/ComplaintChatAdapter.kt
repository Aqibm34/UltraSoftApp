...
//import com.example.yourmudrasales.data.model.complain.Chat
//import com.example.yourmudrasales.databinding.ComplaintChatLayoutBinding
//import com.example.yourmudrasales.databinding.ComplaintChatLayoutUserBinding
//import com.example.ultrasoft.ui.adapters.ComplaintsListAdapter
//import com.example.yourmudrasales.utility.*
//
...
//                    Utils.loadPicture(
//                        context,
//                        AppConstants.COMPLAINT_ATTACHMENT_URL + list[position].complainattachment,
//                        holder.binding.ivAttachment
//                    )
//
//                    holder.binding.tvUser.text = list[position].messageBy
//                    if (list[position].resolvedByUserName.isNullOrEmpty() && list[position].resolvedByUserEmail.isNullOrEmpty()) {
...
//                            "%s ~ %s@yourmudra.in",
//                            list[position].resolvedByUserName,
//                            list[position].resolvedByUserEmail?.let {
...
//                        if (list[position].complainattachment.isNullOrEmpty()) View.GONE else View.VISIBLE
...
//                            "%s ~ %s",
//                            list[position].resolvedByUserName,
//                            list[position].resolvedByUserEmail
//                        )
//                    }
//                    holder.binding.tvDate.text = list[position].createdDate.let {
//                        Utils.parseDateWithTimeZone(
