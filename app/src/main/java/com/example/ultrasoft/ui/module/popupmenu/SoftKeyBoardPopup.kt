...
import com.example.ultrasoft.utility.Utils.Companion.toPx
import com.example.yourmudrasales.ui.module.popupmenu.MenuRecyclerView
...
class SoftKeyBoardPopup(
    ...
    private val defaultHorizontalMargin = 32.toPx()
    private val defaultBottomMargin = 8.toPx()
    ...
    private fun showAtTop() {
        isShowAtTop = true
        isFocusable = true
        setSize(rootView.width - defaultHorizontalMargin, keyboardHeight - 50)
        val windowRect = Rect().apply {
            rootView.getWindowVisibleDisplayFrame(this)
        }
        val y =
